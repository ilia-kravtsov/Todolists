...
export const authAPI = {
    login(logData: LoginParamsType) {
        return instance.post<ResponseType<{ userId: number }>, AxiosResponse<ResponseType<{ userId: number }>>, LoginParamsType>('auth/login', logData)
    },
    me() {

...
test("correct todolist should be added", () => {
  ...
  const endState = todolistsReducer(startState, todolistsThunks.addTodolist.fulfilled({ todolist }, 'requestId', 'new todolist'));
...
test("correct todolist should change its name", () => {
  ...
  const action = todolistsThunks.changeTodolistTitle.fulfilled({ id: todolistId2, title: newTodolistTitle }, 'requsetId', { id: todolistId2, title: newTodolistTitle });
